        ...
        <form action={createJobPosting} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input name="title" required placeholder="e.g. Senior AI Engineer" className="w-full" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-900">Department</label>
              <select name="department" className="w-full h-10 px-3 rounded-md border border-slate-200 bg-white text-sm outline-none focus:ring-2 focus:ring-indigo-500">
          ...
          <div className="space-y-2">
            ...
            <Input name="skills" required placeholder="e.g. Python, PyTorch, React, SQL" className="w-full" />
          </div>
